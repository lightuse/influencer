...
describe('Influencer Routes', () => {
  ...
  it('GET /influencers/influencer/:influencerId/stats should call getInfluencerStats', async () => {
    const response = await request(app).get(
      '/influencers/influencer/123/stats'
    );
    expect(response.status).toBe(200);
  ...
  it('GET /influencers/influencers/top/likes should call getTopInfluencersByLikes', async () => {
    const response = await request(app).get(
      '/influencers/influencers/top/likes?limit=10'
    );
    expect(response.status).toBe(200);
  ...
  it('GET /influencers/influencers/top/comments should call getTopInfluencersByComments', async () => {
    const response = await request(app).get(
      '/influencers/influencers/top/comments?limit=5'
    );
    expect(response.status).toBe(200);
  ...
  it('GET /influencers/influencer/:influencerId/nouns should call getTopNouns', async () => {
    const response = await request(app).get(
      '/influencers/influencer/456/nouns?limit=15'
    );
    expect(response.status).toBe(200);
